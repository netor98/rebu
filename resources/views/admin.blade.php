            ...
            <tbody>
                @foreach($products as $product)
                    <tr class="bg-white border-b" id="{{$product->id}}">
                        ...
                        <td class="px-3 py-4">
                            <div class="showPhoto">
                                <div id="imagePreview" style="@if ($product->image != '') background-image:url('https://vast-zebra-production.up.railway.app/uploads/{{ $product->image }}')@else background-image: url('{{ url('/img/fondo.jpg') }}') @endif;">
                                </div>
                            </div>
